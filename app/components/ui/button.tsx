  ...
  "inline-flex items-center cursor-pointer justify-center disabled:cursor-auto disabled:opacity-50 gap-1.5 whitespace-nowrap rounded-sm transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 [&_svg]:opacity-80 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          'ring ring-neutral-900/10 bg-white shadow hover:bg-violet-500/10 hover:text-indigo-500 hover:ring-indigo-500/40 focus:ring-2 focus:ring-indigo-500/20 focus:ring-offset-2 focus:ring-offset-indigo-300 text-neutral-500',
        secondary:
        ...
        destructive:
          'bg-white px-2 py-2 text-xs font-medium text-neutral-600 shadow ring-1 hover:shadow-lg hover:ring-2 hover:shadow-rose-500/15 ring-neutral-900/10 ease-in-out hover:bg-rose-500/5 hover:ring-rose-500/20 hover:text-rose-500 dark:bg-neutral-700 dark:text-neutral-300 dark:ring-neutral-100/20 dark:hover:bg-rose-500/10 dark:hover:ring-rose-500/20 dark:hover:text-rose-500 dark:hover:shadow-rose-500/5',
        muted: 'bg-neutral-900/10 text-neutral-600 shadow-xs hover:bg-neutral-900/20',
        ghost: 'hover:bg-violet-500/10 text-neutral-600 hover:text-indigo-500',
        link: 'text-neutral-600 hover:text-indigo-500 underline-offset-4 hover:underline',
        display:
          'bg-white px-2 py-2 text-xs font-medium text-neutral-600 shadow ring-1 hover:shadow-lg hover:ring-2 hover:shadow-indigo-500/15 ring-neutral-900/10 ease-in-out hover:bg-violet-500/5 hover:text-indigo-500 hover:ring-indigo-500/20 focus:ring-2 focus:ring-indigo-500/20 focus:ring-offset-2 focus:ring-offset-indigo-300 group-hover:flex dark:bg-neutral-700 dark:text-neutral-300 dark:ring-neutral-100/20 dark:hover:bg-violet-500/10 dark:hover:text-indigo-500 dark:hover:ring-indigo-500/20 dark:hover:shadow-indigo-500/5',
      },
      size: {
